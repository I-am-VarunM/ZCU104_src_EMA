...
# module references:
# Measurement_Load, Measurement_Load, Simulated_Load_IP_Core, pwm, split_gpio
...
proc create_root_design { parentCell } {
  ...
  # Create instance: split_gpio_0, and set properties
  set block_name split_gpio
  set block_cell_name split_gpio_0
  if { [catch {set split_gpio_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $split_gpio_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net axi_gpio_2_gpio2_io_o [get_bd_pins axi_gpio_2/gpio2_io_o] [get_bd_pins split_gpio_0/in_en]
