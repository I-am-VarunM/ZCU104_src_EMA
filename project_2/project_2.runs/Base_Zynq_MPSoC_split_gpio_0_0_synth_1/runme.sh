...
HD_PWD='/home/manvar00/Downloads/RELEASE_DVD/vivado_designs/zcu104_src_ema/project_2/project_2.runs/Base_Zynq_MPSoC_split_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Base_Zynq_MPSoC_split_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Base_Zynq_MPSoC_split_gpio_0_0.tcl
